...
router.put('/skills', [
  auth,
  check('skills', 'Skills information is required').isArray()
...
router.put('/expertise', [
  auth,
  check('expertise', 'Expertise information is required').isArray()
 ...
 * @access Private
 */
router.delete('/certification/:certId', auth, mentorController.deleteCertification);
 ...
 * @access Private
 */
router.post('/request-verification', auth, mentorController.requestVerification);
